...
describe('Create a new software advisory & export it', () => {
  it('Create a new software advisory & export it', () => {
    ...
    cy.contains('Document ID').parent().find('input').click().type('Test-001')
    ...
    cy.contains('Contact Details')
      ...
      .find('input')
      .click()
      .type('contact@testpublisher.com')
    ...
    cy.contains('Name').parent().find('input').click().type('Test Vendor')
    cy.wait(500)
    ...
    cy.contains('Description')
      ...
      .find('textarea')
      .click()
      .type('This is a test product')
    cy.wait(500)
    cy.contains('Save').click()
    cy.contains('Test Software')
      .parent()
      .parent()
      .parent()
      .parent()
    ...
    cy.contains('Name').parent().find('input').click().type('1.0.0')
    cy.wait(500)
    cy.contains('Save').click()
    ...
    cy.contains('Test Hardware')
      ...
      .click()
    cy.contains('Add Version').click()
    cy.contains('Name').parent().find('input').click().type('1.2.0')
    cy.wait(500)
    cy.contains('Save').click()
